...
def plotTiempoAlerta(filename1,filename2,latmin,latmax,lonmin,lonmax,tmin,tmax,db_name):
    ...
    fig = plt.figure(figsize=(6*Escala_Grafico,3*Escala_Grafico))
    ax = plt.axes()
    ...
    ax.set_xlabel('Tiempo Alerta (Centinela)', fontsize=14)
    ...
    ax.set_ylabel('Frecuencia', fontsize=14)
    ax.set_xlabel('Tiempo Alerta (Santiago)', fontsize=14)
